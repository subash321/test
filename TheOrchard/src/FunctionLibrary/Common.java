...
public class Common {
   ...
   //public static String url="http://192.168.0.104:9090";
	//InternalTools	
	public static String url_iT_Customer = "http://internal.alpha.theorchard.com";
	public static String url_iT_Edit_Ex_Release = "http://internal.alpha.theorchard.com";
	public static String url_IT_Edit_Release = "http://internal.alpha.theorchard.com";		
	public static String url_IT_Vendor = "http://internal.alpha.theorchard.com";
	public static String url_IT_YouTube = "http://internal.alpha.theorchard.com";
	public static String login_iT_Customer  = "/oa";
	public static String login_iT_Edit_Ex_Release  = "/oa";
	public static String login_IT_Edit_Release  = "/oa";
	public static String login_IT_Vendor = "/oa";
	public static String login_IT_YouTube  = "/oa";
	//Rb_FilmRelease	
	public static String url_Rb_FilmRelease = "http://rb4.alpha.theorchard.com";
	public static String login_Rb_FilmRelease = "/alw";
	//ReleaseBuilder
	public static String url_RB_ArtistCatalogue = "http://rb4.alpha.theorchard.com";
	public static String url_RB_Release = "http://trunk.synergy.theorchard.com";
	public static String url_RB_Tracks = "http://trunk.synergy.theorchard.com/";
	public static String login_RB_Tracks = "/alw";
	public static String login_RB_Release   = "/alw";
	public static String login_RB_ArtistCatalogue = "/alw";
	// Login	
	public static String url_Login = "http://trunk.synergy.theorchard.com/";
	public static String login_Login  = "/alw";
	//RB_ReleaseArtist
	public static String url_RB_ReleaseArtist = "http://trunk.synergy.theorchard.com/";
	public static String login_RB_ReleaseArtist  = "/alw";
		

	
	//URLandLoginpath
	public static String url = url_Login;
	public static String login = login_Login;
    //Browsers
	public static String browser ="*firefox";
	public static String IEbrowser="*iexplore";
	public static String Cbrowser="*googlechrome";
	public static String safaribrowser="*safariproxy";
	
	/*
	 * EditTerritoriesRestriction
	 */
	public static String dd_CIRelBuilder1="//li[@id='tCatalogInfo']/ul/li[1]/a";
	public static String frm_Release1="id=view_exarelease_form";
	public static String lnk_Release="//form[@id='view_exarelease_form']/table/tbody/tr[1]/td[1]/div[2]/a";
	public static String dv_RelBasics="class=releaseBasics";
	public static String btn_SubFinRelease="id=submit_final_button";
	public static String lnk_ETRestrictions="edit_territories";
	public static String chk_CForSale0="ui-multiselect-select1-option-0";
	public static String chk_CForSale1="ui-multiselect-select1-option-1";
	public static String btn_Add="id=add";
	public static String btn_Remove="id=remove";
//	SaveButton
	public static String btn_Save="submit_your_territories";
	public static String btn_Save2="id=submit_link";
	/*
	 * iT_CustomerElements
	 */
	//	iT_CustomerElements.Login
	public static String txt_UName_02="css=input[name=\"username\"]";
	public static String txt_Pwd="css=input[name=\"password\"]";
	public static String btn_Submit_02="css=input[type=\"submit\"]";
...
/*	public static String dd_DistributeMenu = "//div[@id='main_navigation']/div[3]/div[3]/div";
	...
	public static String btn_CRelease="css=#saveRelease > span";// 1. //a[@id='saveRelease']/span 2. css=#saveRelease > span
	public static String btn_NImprint="css=#newImprintButton";
    ...
    public static Selenium CsetUp() throws InterruptedException{
		...
		Common setUp= new Common();
		StartSeleniumServer Server=new StartSeleniumServer();
		System.out.println("DefaultSelenium");
		setUp.selenium = new DefaultSelenium("localhost",4444,"*firefox",url);
