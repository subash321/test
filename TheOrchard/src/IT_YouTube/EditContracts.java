...
public class EditContracts extends SeleneseTestBase{
...
//		selenium.addSelection("css=select[name=\"lstTerritory[]\"]","Ukraine"); // new
	...
	//  EndIf
	//	FieldsValues
		String OrchardClose = selenium.getEval("'The Orchard'");
		System.out.println("EditContractsDebug_06");
		selenium.select("css=select[name=\"orchrep_name\"]", selenium.getEval("'" + OrchardClose + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"contract_version\"]"));
		String ContractVersion = selenium.getEval("'OOP'");
		selenium.select("css=select[name=\"contract_version\"]", selenium.getEval("'" + ContractVersion + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"dig_distribution_type[1]\"]"));
		String DigitalDistributionType = selenium.getEval("'Tone'");
		System.out.println("EditContractsDebug_07");
		selenium.click("css=input[name=\"dig_distribution_type[1]\"]");
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"exclusive\"]"));
		String Exclusivity = selenium.getEval("'Yes - Digital'");
		selenium.select("css=select[name=\"exclusive\"]", selenium.getEval("'" + Exclusivity + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"third_party_responsibility\"]"));
		String Responsibilities = selenium.getEval("'Standard'");
		selenium.select("css=select[name=\"third_party_responsibility\"]", selenium.getEval("'" + Responsibilities + "'"));
		Thread.sleep(1000);
		System.out.println("EditContractsDebug_08");
		verifyTrue(selenium.isElementPresent("css=select[name=\"unlimited_roll\"]"));
		String UnlimitedRoll = selenium.getEval("'Yes'");
		selenium.select("css=select[name=\"unlimited_roll\"]", selenium.getEval("'" + UnlimitedRoll + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"rollover_length_in_months\"]"));
		String RolloverLength = selenium.getEval("'2'");
		selenium.type("css=input[name=\"rollover_length_in_months\"]", selenium.getEval("'" + RolloverLength + "'"));
		Thread.sleep(1000);
		System.out.println("EditContractsDebug_09");
		verifyTrue(selenium.isElementPresent("css=select[name=\"can_terminate\"]"));
		String RolloverEnds = selenium.getEval("'No'");
		selenium.select("css=select[name=\"can_terminate\"]", selenium.getEval("'" + RolloverEnds + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"notice_required_in_days\"]"));
		String Notice = selenium.getEval("'7'");
		selenium.type("css=input[name=\"notice_required_in_days\"]", selenium.getEval("'" + Notice + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"txtDigitalSplit\"]"));
		String Split_DIGITAL = selenium.getEval("'0.54'");
		selenium.type("css=input[name=\"txtDigitalSplit\"]", selenium.getEval("'" + Split_DIGITAL + "'"));
		Thread.sleep(1000);
		System.out.println("EditContractsDebug_10");
		verifyTrue(selenium.isElementPresent("css=input[name=\"txtPhysicalSplit\"]"));
		String Split_PHYSICAL = selenium.getEval("'0.12'");
		selenium.type("css=input[name=\"txtPhysicalSplit\"]", selenium.getEval("'" + Split_PHYSICAL + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"txtBackCatalogueFee\"]"));
		String Cap_BackCatalogue = selenium.getEval("'9999'");
		selenium.type("css=input[name=\"txtBackCatalogueFee\"]", selenium.getEval("'" + Cap_BackCatalogue + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"txtNewReleasesFee\"]"));
		String Cap_NewReleases = selenium.getEval("'9999'");
		selenium.type("css=input[name=\"txtNewReleasesFee\"]", selenium.getEval("'" + Cap_NewReleases + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"extend_until_recouped\"]"));
		String ExtendTerm = selenium.getEval("'No'");
		selenium.select("css=select[name=\"extend_until_recouped\"]", selenium.getEval("'" + ExtendTerm + "'"));
		Thread.sleep(1000);
		...
		String RecoupablePercentage = selenium.getEval("'0.55'");
		System.out.println("EditContractsDebug_011.01");
		selenium.type("css=input[name=\"advance_recoupable_percentage\"]", selenium.getEval("'" + RecoupablePercentage + "'"));
		Thread.sleep(1000);
...
//		selenium.addSelection("css=select[name=\"rights_granted[]\"]", "label=Synch");
		...
		selenium.select("css=select[name=\"oms_type\"]", selenium.getEval("'" + FullTrackPublishing + "'"));
		Thread.sleep(1000);*/
		...
		String OMS = selenium.getEval("'0.20'");
		selenium.type("css=input[name=\"oms_fee_percentage\"]", selenium.getEval("'" + OMS + "'"));
		Thread.sleep(1000);
		...
		String TrackRestrictions = selenium.getEval("'No'");
		selenium.select("css=select[name=\"possible_track_restrictions\"]", selenium.getEval("'" + TrackRestrictions + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"payment_interval\"]"));
		String PaymentInterval = selenium.getEval("'Month'");
		selenium.select("css=select[name=\"payment_interval\"]", selenium.getEval("'" + PaymentInterval + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"pay_after\"]"));
		String PayAfter = selenium.getEval("'30 Days'");
		selenium.select("css=select[name=\"pay_after\"]", selenium.getEval("'" + PayAfter + "'"));
		Thread.sleep(1000);
		System.out.println("EditContractsDebug_014");
		verifyTrue(selenium.isElementPresent("css=#show_credit_card"));
		String CreditCard = selenium.getEval("'Y'");
		selenium.select("css=#show_credit_card", selenium.getEval("'" + CreditCard + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=#youtube_composition_clause"));
		String YouTube = selenium.getEval("'No'");
		Thread.sleep(1000);
		selenium.select("css=#youtube_composition_clause", selenium.getEval("'" + YouTube + "'"));
...
//		selenium.addSelection("css=select[name=\"lstContinents[]\"]","label=North America");
		...
		String AdminSplit = selenium.getEval("'0.6'");
		System.out.println("EditContractsDebug_016");
		selenium.type("css=input[name=\"sync_admin_commission\"]",selenium.getEval("'" + AdminSplit + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"sync_admin_response_time\"]"));
		String ResponseTim = selenium.getEval("'4'");
		selenium.type("css=input[name=\"sync_admin_response_time\"]",selenium.getEval("'" + ResponseTim + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=select[name=\"sync_admin_type_of_deal\"]"));
		String TypeofDeal = selenium.getEval("'Publishing Admin Only'");
		selenium.select("css=select[name=\"sync_admin_type_of_deal\"]",selenium.getEval("'" + TypeofDeal + "'"));
		Thread.sleep(1000);
		System.out.println("EditContractsDebug_017");
		verifyTrue(selenium.isElementPresent("css=input[name=\"publishing_admin_commission\"]"));
		String AdministrationSplit = selenium.getEval("'0.5'");
		selenium.type("css=input[name=\"publishing_admin_commission\"]",selenium.getEval("'" + AdministrationSplit + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"publishing_admin_limit_grant_of_rights\"]"));
		String GrantofRights = selenium.getEval("'no'");
		selenium.type("css=input[name=\"publishing_admin_limit_grant_of_rights\"]",selenium.getEval("'" + GrantofRights + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"publishing_admin_misc_provisions\"]"));
		String MiscPrevisions = selenium.getEval("'yes'");
		selenium.type("css=input[name=\"publishing_admin_misc_provisions\"]", selenium.getEval("'" + MiscPrevisions + "'"));
		Thread.sleep(1000);
		...
		String CollectionSplit = selenium.getEval("'0.45'");
		selenium.type("css=input[name=\"royalty_collection_commission\"]", selenium.getEval("'" + CollectionSplit + "'"));
		Thread.sleep(1000);
		verifyTrue(selenium.isElementPresent("css=input[name=\"brand_split\"]"));
		String Split_BRAND = selenium.getEval("'0.1'");
		selenium.type("css=input[name=\"brand_split\"]", selenium.getEval("'" + Split_BRAND + "'"));
		Thread.sleep(1000);
