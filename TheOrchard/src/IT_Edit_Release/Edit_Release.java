...
public class Edit_Release extends SeleneseTestBase{
...
*/		
	...
	//	EditReleaseDebug_01
		...
		String Primary_Genre ="Action & Adventure";
		System.out.println("EditReleaseDebug_09");
		verifyTrue(selenium.isElementPresent("id=primary_genre_id"));
		selenium.select("id=primary_genre_id",Primary_Genre);
		System.out.println("EditReleaseDebug_09.Oone");
	//	selenium.type("name=genre_note", "Genre Note");
		String Format="DigiBeta";
		...
		selenium.type("css=input[name=\"reasons_film[be_movies]\"]", "BE-Movies");
